			...
			sss.loadAndRegisterSheet(Services.io.newURI('data:text/css;base64,' + btoa((function () {/*
				...
				@-moz-document url("chrome://browser/content/browser.xul"){
					...
					#UCloadingBar{
						...
						background-image:linear-gradient(to right, rgba(255,255,255,0) 0%, rgba(255,255,255,0.25) 25%, rgba(50,150,253,1) 100%);
						width:100%;
					}
					...
					#UCloadingBar[connecting]::after {
						...
						background-image: radial-gradient(ellipse farthest-corner at center top, rgba(50,150,253, 1) 25%, rgba(255,255,255,0.25) 100%);
						width: 30%;
						position: absolute;
					}
					...
					#UCloadingBar[style]:not([connecting]):not([complete])::before{
						...
						width: 100px;
						height: 100%;
						box-shadow: 0px 0px 10px 3px rgba(50,150,253,1), 0px 0px 5px 2px rgba(50,150,253,1);
